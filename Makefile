...
prueba: pruebaLista.o ListaAnterior.o Lista_InsertarFin.o Lista_Ultimo.o Lista_InsertarInicio.o Lista_Conteo.o Lista_vacia.o Lista_Primero.o Lista_Inicializar.o Lista_Sacar.o Lista_InsertarAntes.o Lista_SacarTodos.o Lista_InsertarDespues.o Lista_Siguiente.o Lista_Buscar.o liblista.so 
	gcc $(LIBS) obj/* -o $@

liblista.so: pruebaLista.o ListaAnterior.o Lista_InsertarFin.o Lista_Ultimo.o Lista_InsertarInicio.o Lista_Conteo.o Lista_vacia.o Lista_Primero.o Lista_Inicializar.o Lista_Sacar.o Lista_InsertarAntes.o Lista_SacarTodos.o Lista_InsertarDespues.o Lista_Siguiente.o Lista_Buscar.o
	gcc -shared  obj/* -o lib/liblista.so

pruebaLista.o: src/pruebaLista.c
	gcc -fPIC -Wall -g -c $(INCLUDE) $^ -o obj/$@
